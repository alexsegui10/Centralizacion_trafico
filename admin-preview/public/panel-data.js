(function () {
  ...
  var existing = document.querySelector('script[data-panel-supabase="1"]');
  if (existing) {
    existing.addEventListener("load", startPanelData);
    return;
  }
  ...
  script.async = true;
  script.setAttribute("data-panel-supabase", "1");
  script.onload = startPanelData;
